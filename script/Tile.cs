...
namespace Ronin
{
  ...
  public partial class Tile : StaticBody3D
  {
    ...
    {
      get => _heightMap;
      set => this.SetValue(ref _heightMap, value, SignalName.ValueChanged);
    }
    ...
    {
      get => _normalMap;
      set => this.SetValue(ref _normalMap, value, SignalName.ValueChanged);
    }
    ...
    {
      get => _shader;
      set => this.SetValue(ref _shader, value, SignalName.ValueChanged);
    }
    ...
    {
      get => _tileCount;
      set => this.SetValue(ref _tileCount, value, SignalName.ValueChanged);
    }
    ...
    {
      get => _heightScale;
      set => this.SetValue(ref _heightScale, value, SignalName.ValueChanged);
    }
    ...
    {
      get => _chunkCount;
      set => this.SetValue(ref _chunkCount, value, SignalName.ValueChanged);
    }
    ...
    {
      get => _chunkIndex;
      set => this.SetValue(ref _chunkIndex, value, SignalName.ValueChanged);
    }
    ...
    public void SetupCollision()
    {
      ...
      _collisionShape = this.GetOrCreate<CollisionShape3D>();
    ...
    public HeightMapShape3D CreateHeightMapShape(Image heightMap)
    {
      ...
      for (int x = 0; x < shape.MapWidth; x++)
      {
        for (int y = 0; y < shape.MapDepth; y++)
        {
          ...
          mapData[y * shape.MapWidth + x] =
            GetNearestPixel(pos, heightMap) * _heightScale;
        }
      }
    ...
    {
      if (_shader is null || _heightMap is null || _normalMap is null)
        return;
